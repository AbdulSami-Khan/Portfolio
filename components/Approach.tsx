    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description="We'll all collabirate to map out your website's goal's, target audience, and key functionalities. We'll discuss things like site structure, navigation, and content requiremnets."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <div className="text-center absolute left-[50%] translate-x-[-50%] translate-y-[-50%] top-[50%] group-hover/canvas-card:-translate-y-4 group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center">
          {icon}
        </div>
